...
export const ArtifactPanel: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      >
        Убивая монстров и боссов, вы собираете их магическую{" "}
        <strong>Эссенцию</strong>. Наполняйте ей древние реликвии, чтобы
        получать колоссальные постоянные прибавки к силе, золоту и опыту!
      </p>
          ...
          return (
            ...
            >
              ...
              >
                <div>
                  Текущий бонус:{" "}
                  <strong style={{ color: "#2cdb7f" }}>
                    +{currentBonus.toFixed(0)}%
                  </strong>
                </div>
